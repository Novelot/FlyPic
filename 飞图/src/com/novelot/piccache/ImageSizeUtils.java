...
public final class ImageSizeUtils {
	...
	static {
		...
		maxBitmapDimension = Math.max(maxTextureSize[0],
	...
	public static int computeImageSampleSize(int srcWidth, int srcHeight,
		...
		// while ((halfWidth / scale) > targetWidth || (halfHeight / scale) >
		// targetHeight) { // ||
		// scale *= 2;
		// }
		// } else {
	...
	private static int considerMaxTextureSize(int srcWidth, int srcHeight,
		...
		final int maxWidth = maxBitmapDimension;
		final int maxHeight = maxBitmapDimension;
	...
	// if ((viewScaleType == ViewScaleType.FIT_INSIDE && widthScale >=
	// heightScale)
	 ...
	 * @return Computed scale
	 */
	public static float computeImageScale(int srcWidth, int srcHeight,
			int targetWidth, int targetHeight, boolean stretch) {
		// final int srcWidth = srcSize.getWidth();
		// final int srcHeight = srcSize.getHeight();
		// final int targetWidth = targetSize.getWidth();
		// final int targetHeight = targetSize.getHeight();
